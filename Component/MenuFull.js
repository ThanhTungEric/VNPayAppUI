...
import { FontAwesome5, Octicons, FontAwesome, MaterialIcons, AntDesign } from '@expo/vector-icons';
                ...
                <View style={{ flexDirection: "row", marginTop: 44 }}>
                    ...
                    <View style={styles.userNameSpace}>
                        <View style={styles.userName}>
                            <Text>{getTime}</Text>
                            <Text style={{ fontWeight: "bold", fontSize: 15 }}>Nguyễn Thành Luân</Text>
                        </View>
                        ...
                        <TouchableOpacity onPress={() => handleBalance()}>
                            <View style={styles.soDuSpace}>
                                <View style={{ flexDirection: "row", alignItems: "center" }}>
                                    <Image style={styles.imageSoDu} source={require("../assets/icons/sodu.png")} />
                                    <AntDesign name="eye" size={18} color="#c9d9e8" />
                                    <Text style={{ fontWeight: "bold", color: "#fff", marginLeft: 5 }}>9 524 232 234 VND</Text>
                                </View>
                                <View
                                    style={{
                                        flexDirection: "row",
